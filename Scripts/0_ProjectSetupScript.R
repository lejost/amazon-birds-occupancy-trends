# R Project Setup based on Strategic Coding Practices 
# and using barracudar functions distributed by Nicholas J. Gotelli,
# University of Vermont in  19 July 2023
# 19 October 2023
...
# set_up_log()
set_up_log(my_logfile='logfile.txt', console_echo=FALSE)
...
# From here on down, commands not used for Quetzal Project
